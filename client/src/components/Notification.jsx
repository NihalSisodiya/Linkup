...
const Notification = ({t, message}) =>{
    ...
    return (
            ...
            <div className="flex-1 p-4" >
                <div className="flex items-start">
                    ...
                    <div className="ml-3 flex-1">
                        <p className="text-sm font-medium text-gray-500">{message.from_user_id.full_name}</p>
            ...
            <div className="flex border-l border-gray-200">
                <button onClick={() => { navigate(`/messages/${message.from_user_id._id}`); toast.dismiss(t.id)}} className="p-4 text-indigo-600 font-semibold"> Reply </button>
            </div>
