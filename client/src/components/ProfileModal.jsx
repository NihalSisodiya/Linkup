                ...
                <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <form className="space-y-4" onSubmit={e => toast.promise(handleSaveProfile(e), {loading: 'Saving...'})}>
                        ...
                        <div>
                            ...
                            <textarea type="text" className="w-full p-3 border border-gray-200 rounded-lg" placeholder="Please enter a short bio" onChange={(e) => setEditForm({...editForm, bio: e.target.value})} value={editForm.bio}/>
                        </div>
                        ...
                        <div className="flex justify-end space-x-3 pt-6">
                            ...
                            <button onClick={() => setShowEdit(false)} type="button" className="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transitions-colors cursor-pointer">Cancel</button>
