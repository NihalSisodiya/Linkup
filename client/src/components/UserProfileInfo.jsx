            ...
            <div className="flex flex-col md:flex-row items-start gap-6">
                ...
                <div className="w-full pt-16 md:pt-0 md:pl-36">
                    <div className="flex flex-col md:flex-row items-start justify-between">
                        ...
                        {/* If user is not on others profile that means he is opening his own profile so we will give them a edit button */}
                        {!profileId && 
                    ...
                    <div className="flex items-center gap-x-6 gap-y-2 text-sm text-gray-500 mt-4">
                        ...
                        <span className="flex items-center gap-1.5">
                            ...
                            Joined <span className="font-medium">{moment(user.createdAt).from()}</span>
                        </span>
                    </div>
