            ...
            if (file.type.startsWith("video")) {
                ...
                video.onloadedmetadata = () => {
                    ...
                    if(video.duration > MAX_VIDEO_DURATION){
                        toast.error("Video duration cannot be exceed 1 minute.");
                        setMedia(null);
                        setPreviewUrl(null);
                    }else{
                        setMedia(file);
            ...
            <div className="w-full max-w-md">
                <div className="text-center mb-4 flex items-center justify-between">
                    ...
                    <div className="rounded-lg h-96 flex items-center justify-center relative" style={{backgroundColor: background}}>
                         {mode === 'text' && (
                            <textarea className="bg-transparent text-white w-full h-full p-6 text-lg resize-none focus:outline-none" onChange={(e)=>setText(e.target.value)} value={text} placeholder="What's on your mind?"/>
                         )}
                         {
