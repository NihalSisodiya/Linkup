...
// Create an empty object to store SSE (Server Side Event) connections
const connections = {};

export const sseController = async (req, res) => {
    const {userId} = req.params;
    console.log('New client connection : ', userId);
    ...
    // Add the Client's response object to the connection's object
